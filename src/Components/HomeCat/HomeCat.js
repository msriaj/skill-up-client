          ...
          <div className="grid grid-cols-2 gap-2 row-gap-6 mb-10 sm:grid-cols-3 lg:grid-cols-7">
            {category.map((cat) => (
              <div
                ...
                className="border shadow-lg  text-center flex items-center justify-center text-xs border-blue-900 rounded-md py-3 px-2  hover:bg-blue-900 hover:text-white cursor-pointer font-bold"
              >
                {cat.CategoryName}
              </div>
            ))}
